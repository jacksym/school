...
ogle1 = pdata_proc.OGLE_data(path+event)


print("saving figure phot_dat.png")
fig1, ax1 = plt.subplots()
ogle1.plot(ax1, event)
fig1.savefig("./images/phot_dat.png", dpi=300)

print("saving figure freq_dist.png")
...
print("saving figure cumu_dist.png")
...
print("saving figure t_dist.png")
st_fig, st_ax = plt.subplots()
t = np.linspace(-5, 5, 200)
for i in range(1, 10):
    label = r'$\nu = %s$' % i
    st_ax.plot(t, pdata_proc.student_form(t, i, 0), label=label)
    st_ax.legend()
st_fig.savefig("./images/t_dist.png", dpi=300)

print("saving figure t_cdf.png")
...
print("saving figure lo_dist.png")
lo_fig, lo_ax = plt.subplots()
x = np.linspace(-5, 5, 200)
for i in range(1, 10):
    label = r'$\gamma = %s$' % i
    lo_ax.plot(t, pdata_proc.cauchy_form(x, 0, i), label=label)
lo_ax.legend()
lo_fig.savefig("./images/lo_dist.png", dpi=300)


print("saving figure cauchy_cdf.png")
...
print("saving figure err_cor1.png")
fig7, ax7 = plt.subplots()
ogle1.cumu_dist(ogle1.ress, ax7)
new_meas = ogle1.man_err(ogle1.diffs, ogle1.err_const, 0.01)
ogle1.cumu_dist(new_meas, ax7)
ax7.arrow(-3, 0.15, 0.5, 0, linewidth=3, head_length=0.3, head_width=0.03)
ax7.arrow(3, 0.93, -0.5, 0, linewidth=3, head_length=0.3, head_width=0.03)
fig7.savefig("./images/err_cor1.png", dpi=300)

print("saving figure gauss_ec.png")
...
final_ax.set_xlabel("Source Star's Constant Magnitude")
final_ax.set_ylabel(r'Error Correction $\mathcal{C}$')
