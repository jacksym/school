...
class OGLE_data:
    ...
    def plot(self, ax, title):
        ...
        ax.errorbar(self.df[0], self.df[1], self.df[2], fmt='none', color='white', linewidth=0.5)
    ...
    def freq_dist_r(self, ax):
        ...
        ax.scatter(self.meas, self.freqs, marker='.', color='white')
    ...
    def cumu_dist(self, meas, ax):
        ...
        ax.step(self.meas_c, self.cdf, where='mid', color='white')
        # ax.scatter(self.meas_c, self.cdf, marker='.', color='white')
    ...
    def qqplot(self, ax, model):
        ...
        ax.set_aspect('equal')
        ax.scatter(model, mags, color='white', marker='.')
    ...
    def gauss_model_ec(self, diffs, ax):
        ...
        ax.step(ress, ecdf, where='mid', color='white')
    ...
    def ks_test(self, meas, meas_cdf, model, ax):
        ...
        # print(infl_arg, infl)
        ax.axvline(infl, color='white', linewidth=0.6)
